...
to setup-person
  ...
  ;; Assign each person a coordinate
  (foreach sort people coordinates [
    [p coord] ->
    ask p [ setxy (item 0 coord) (item 1 coord) ]
  ])

  ;; Move each person to a random assembly point
  ask people [
    move-to one-of (list assembly-point1 assembly-point2)
